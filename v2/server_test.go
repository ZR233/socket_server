...
func (t TestHandler) HeaderHandler(headerData []byte, client *Session) (bodyLen int, err error) {
...
func (t TestHandler) BodyHandler(bodyData []byte, client *Session) (err error) {
